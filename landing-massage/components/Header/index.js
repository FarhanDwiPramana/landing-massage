...
export default function Header() {
  return (
    <header className="w-full text-gray-700 bg-[#EDE0D4] shadow-md body-font">
      <div className="container flex flex-col items-start p-6 mx-auto md:flex-row">
        ...
        <nav className="flex items-center justify-center text-base text-[#7F5539] md:ml-auto">
          <a
            href="#_"
            className="mr-5 font-medium hover:text-[#5C4033] relative after:content-[''] after:absolute after:left-0 after:bottom-0 after:w-0 after:h-[2px] after:bg-[#5C4033] after:transition-all after:duration-300 hover:after:w-full"
          >
            Home
          </a>
          <a
          ...
          <a
            href="#_"
            className="font-medium hover:text-[#5C4033] relative after:content-[''] after:absolute after:left-0 after:bottom-0 after:w-0 after:h-[2px] after:bg-[#5C4033] after:transition-all after:duration-300 hover:after:w-full"
          >
            Contact
          </a>
        </nav>
        <div className="items-center h-full pl-6 ml-6 border-l border-gray-20">
          <a
            href="#_"
            className="px-4 py-2 text-xs font-bold uppercase transition-all duration-150 bg-[#A3B18A] text-[#4A4A4A] rounded shadow outline-none active:bg-teal-600 hover:shadow-md hover:text-[#5C4033] hover:bg-[#C3A995] focus:outline-none ease"
          >
            CONTACT ME
          </a>
        </div>
